...
def input_process(image_size):
    input_images = tf.placeholder(tf.uint8, shape=[None, None, 3],name="input")
    with tf.variable_scope("preprocess"):
        image = (tf.to_float(input_images) / 255.0)*2-1 
...
def main():
    ...
    with tf.Session() as sess:
        ...
        save_graph_to_file(sess, sess.graph_def ,"models/yolov2_frozen_graph.pb") 
